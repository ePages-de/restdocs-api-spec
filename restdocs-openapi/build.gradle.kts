...
dependencies {
    ...
    compile("org.springframework.restdocs:spring-restdocs-mockmvc:2.0.2.RELEASE")
    ...
    testCompile("org.springframework.boot:spring-boot-starter-hateoas:2.0.4.RELEASE")
